...
| `[REDACTED_QQ]` | `{{BOT_QQ_ID}}` |
| `[REDACTED_GROUP]` | `{{HOME_CHANNEL}}` |
| `[REDACTED_TOKEN]` | `{{ONEBOT_TOKEN}}` |
| `[REDACTED_SOYO]` | `QQBot` |
| `[REDACTED_USER]` | `{{USERNAME}}` |
| `[REDACTED_CHANNEL]` | `{{CHANNEL_NAME}}` |
| `/home/[REDACTED_USER]/` | `/home/{{USERNAME}}/` |
| `[REDACTED_PATH]/` | 相对路径 |
...
for root, dirs, files in os.walk("."):
    for f in files:
        if f.endswith((".py",".md",".yaml",".json")) and f != "AGENTS.md":
            ...
            for p in ["[REDACTED_QQ]","[REDACTED_TOKEN]","sk-CfBJRQ8u",
                       "[REDACTED_CHANNEL]","[REDACTED_USER]","/home/[REDACTED_USER]/","[REDACTED_PATH]/"]:
